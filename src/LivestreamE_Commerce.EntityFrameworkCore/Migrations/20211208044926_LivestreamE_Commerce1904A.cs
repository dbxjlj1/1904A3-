...
{
    public partial class LivestreamE_Commerce1904A : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GoodsImgModel", x => x.gi_id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GoodsModel", x => x.tg_id);
                });

            migrationBuilder.CreateTable(
                name: "GoodsSpecificationModel",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GoodsSpecificationModel", x => x.gs_id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GoodsTypeModel", x => x.gt_id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ImgModel", x => x.im_id);
                });

            migrationBuilder.CreateTable(
                name: "IndentDetailModel",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_IndentDetailModel", x => x.ind_id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_IndentModel", x => x.ind_id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LogModel", x => x.log_id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MenuModel", x => x.tm_id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrganizationModel", x => x.to_id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RoleMenuModel", x => x.tro_id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RoleModel", x => x.tr_id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SiteModel", x => x.si_id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SpecificationModel", x => x.sp_id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserImgModel", x => x.ui_id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserModel", x => x.tu_id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserRoleFinder", x => x.tug_id);
                });
