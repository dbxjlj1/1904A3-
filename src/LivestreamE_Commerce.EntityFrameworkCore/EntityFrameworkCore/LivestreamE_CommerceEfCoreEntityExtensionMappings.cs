...
{
    public static class LivestreamE_CommerceEfCoreEntityExtensionMappings
    {
        ...
        public static void Configure()
        {
            ...
            OneTimeRunner.Run(() =>
            {
                 ...
                 * USE LivestreamE_CommerceModuleExtensionConfigurator CLASS (in the Domain.Shared project)
